...
func (c *blogServiceClient) CreateBlog(ctx context.Context, in *BlogDto, opts ...grpc.CallOption) (*BlogIdDto, error) {
	out := new(BlogIdDto)
...
func (c *blogServiceClient) UpdateBlog(ctx context.Context, in *BlogDto, opts ...grpc.CallOption) (*emptypb.Empty, error) {
...
func (c *blogServiceClient) DeleteBlog(ctx context.Context, in *BlogIdDto, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
...
func (x *blogServiceListBlogsClient) Recv() (*BlogDto, error) {
	m := new(BlogDto)
...
func (UnimplementedBlogServiceServer) DeleteBlog(context.Context, *BlogIdDto) (*emptypb.Empty, error) {
...
func _BlogService_CreateBlog_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BlogServiceServer).CreateBlog(ctx, req.(*BlogDto))
	}
...
func _BlogService_ReadBlog_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BlogServiceServer).ReadBlog(ctx, req.(*BlogIdDto))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _BlogService_UpdateBlog_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BlogServiceServer).UpdateBlog(ctx, req.(*BlogDto))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _BlogService_DeleteBlog_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BlogServiceServer).DeleteBlog(ctx, req.(*BlogIdDto))
	}
	return interceptor(ctx, in, info, handler)
}
...
func (x *blogServiceListBlogsServer) Send(m *BlogDto) error {
